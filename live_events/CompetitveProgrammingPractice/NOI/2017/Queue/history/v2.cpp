...
unordered_map<ll, int> mp[K];

ll comphsh(simps hsh) {
    return hsh.first * 2e9 + hsh.second;
}
...
int main() {
    ...
    for (int i = 0; i < q; i++) {
        ...
        if (t == 1) {
            ...
            ans = ans * mp[k - 1][comphsh(hsh)] % modval;
