...
int main() {
    ...
    //1: max(range) is fine
    //2: second_max(range) is fine //FIXME
    //3: replace max(range) with max(l, r)
    //4: replace second_max(range) with casework4(range) //FIXME
    //6: replace second_max(range) with casework6(range) //FIXME
