...
class LinRegPerceptron:
    ...
    def pla(self):
        ...
        self.w = np.add(self.w, self.y[cur] * self.X[cur])
        return True
    ...
    def ein(self):
        ...
        if (cnt != 0): #should have no in sample error after perceptron since data is separable
            print(cnt)
            self.showplot()
        ###print(cnt)
        ###self.showplot()
...
if __name__ == '__main__':
    ...
    model = LinRegPerceptron(n, e) #linear regression for classification
