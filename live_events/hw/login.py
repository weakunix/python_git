...
"}")
        ...
        self.verticalLayout_4 = QtWidgets.QVBoxLayout(self.leftSide)
        self.verticalLayout_4.setObjectName("verticalLayout_4")
        self.leftFrame = QtWidgets.QFrame(self.leftSide)
        self.leftFrame.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.leftFrame.setFrameShadow(QtWidgets.QFrame.Raised)
        self.leftFrame.setObjectName("leftFrame")
        self.verticalLayout_15 = QtWidgets.QVBoxLayout(self.leftFrame)
        self.verticalLayout_15.setObjectName("verticalLayout_15")
        self.tabWidget = QtWidgets.QTabWidget(self.leftFrame)
        self.tabWidget.setObjectName("tabWidget")
        self.login = QtWidgets.QWidget()
        self.login.setObjectName("login")
        self.LoginFrame = QtWidgets.QFrame(self.login)
        self.LoginFrame.setGeometry(QtCore.QRect(0, 10, 151, 261))
...
"}")
        ...
        font = QtGui.QFont()
        font.setPointSize(-1)
        self.UsernameInputS.setFont(font)
        self.UsernameInputS.setText("")
        self.UsernameInputS.setEchoMode(QtWidgets.QLineEdit.Password)
        ...
        self.registerbox.setGeometry(QtCore.QRect(0, 10, 151, 261))
...
"}")
        ...
        self.verticalLayout_13 = QtWidgets.QVBoxLayout(self.registerbox)
        ...
        self.verticalLayout_13.addWidget(self.registerlable)
        ...
        self.verticalLayout_13.addWidget(self.registercredentials)
        self.tabWidget.addTab(self.signup, "")
        self.verticalLayout_15.addWidget(self.tabWidget)
        self.signinLocal = QtWidgets.QFrame(self.leftFrame)
...
"}")
        ...
        self.verticalLayout_15.addWidget(self.signinLocal)
        self.socials = QtWidgets.QFrame(self.leftFrame)
...
"}")
        ...
        self.insta.setIconSize(QtCore.QSize(32, 32))
        ...
        self.verticalLayout_15.addWidget(self.socials)
        self.verticalLayout_4.addWidget(self.leftFrame)
...
"}")
        ...
        self.TBtitleFrame.setMaximumSize(QtCore.QSize(16777215, 40))
        ...
        self.SBtimeFrame.setMaximumSize(QtCore.QSize(16777215, 40))
        ...
        self.NBtitleBox.setMaximumSize(QtCore.QSize(16777215, 40))
        ...
        self.menuHWTracker = QtWidgets.QMenu(self.menuBar)
        self.menuHWTracker.setObjectName("menuHWTracker")
        self.menuCustomize_View = QtWidgets.QMenu(self.menuBar)
        self.menuCustomize_View.setObjectName("menuCustomize_View")
        Login.setMenuBar(self.menuBar)
        self.actionQuit = QtWidgets.QAction(Login)
        self.actionQuit.setObjectName("actionQuit")
        self.actionAbout = QtWidgets.QAction(Login)
        self.actionAbout.setObjectName("actionAbout")
        self.actionAbout_2 = QtWidgets.QAction(Login)
        self.actionAbout_2.setObjectName("actionAbout_2")
        self.actionQuit_2 = QtWidgets.QAction(Login)
        self.actionQuit_2.setObjectName("actionQuit_2")
        self.actionShow_news = QtWidgets.QAction(Login)
        self.actionShow_news.setCheckable(True)
        self.actionShow_news.setChecked(True)
        self.actionShow_news.setObjectName("actionShow_news")
        self.actionSchedule = QtWidgets.QAction(Login)
        self.actionSchedule.setCheckable(True)
        self.actionSchedule.setChecked(True)
        self.actionSchedule.setObjectName("actionSchedule")
        self.actionTodo = QtWidgets.QAction(Login)
        self.actionTodo.setCheckable(True)
        self.actionTodo.setChecked(True)
        self.actionTodo.setObjectName("actionTodo")
        self.actionCalendar = QtWidgets.QAction(Login)
        self.actionCalendar.setObjectName("actionCalendar")
        self.menuHWTracker.addAction(self.actionAbout_2)
        self.menuHWTracker.addSeparator()
        self.menuCustomize_View.addAction(self.actionShow_news)
        self.menuCustomize_View.addAction(self.actionSchedule)
        self.menuCustomize_View.addAction(self.actionTodo)
        self.menuBar.addAction(self.menuHWTracker.menuAction())
        self.menuBar.addAction(self.menuCustomize_View.menuAction())

        self.retranslateUi(Login)
        self.tabWidget.setCurrentIndex(1)
        self.actionShow_news.toggled['bool'].connect(self.NEWS.setVisible)
        self.actionSchedule.toggled['bool'].connect(self.SCHEDULE.setVisible)
        QtCore.QMetaObject.connectSlotsByName(Login)

    def retranslateUi(self, Login):
        _translate = QtCore.QCoreApplication.translate
        Login.setWindowTitle(_translate("Login", "Login"))
        self.logintext.setText(_translate("Login", "Login"))
        self.passwordInputS.setPlaceholderText(_translate("Login", "Username"))
        self.UsernameInputS.setPlaceholderText(_translate("Login", "Password"))
...
"Device"))
        ...
        self.TBdesc.setText(_translate("Login", "Geometry stuff"))
        self.SBtime.setText(_translate("Login", "10:01-12:34"))
        self.SBdesc.setText(_translate("Login", "Math"))
        self.NBtitle.setText(_translate("Login", "New as of v1.0"))
        self.NBdesc.setText(_translate("Login", "daksjlflllfa"))
        self.menuHWTracker.setTitle(_translate("Login", "HWTracker"))
        self.menuCustomize_View.setTitle(_translate("Login", "Customize View"))
        self.actionQuit.setText(_translate("Login", "Quit"))
        self.actionAbout.setText(_translate("Login", "About"))
        self.actionAbout_2.setText(_translate("Login", "About"))
        self.actionQuit_2.setText(_translate("Login", "Quit"))
        self.actionShow_news.setText(_translate("Login", "App news"))
        self.actionSchedule.setText(_translate("Login", "Schedule"))
        self.actionTodo.setText(_translate("Login", "Todo"))
        self.actionCalendar.setText(_translate("Login", "Calendar"))
