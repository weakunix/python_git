...
class Ui_Login(object):
        ...
        "}")
                ...
                self.LoginFrame.setGeometry(QtCore.QRect(0, 10, 151, 251))
        ...
        "}")
                ...
                self.registerbox.setGeometry(QtCore.QRect(0, 10, 151, 251))
        ...
        def validate(self):
                username = self.UsernameInputS.text()
                password = self.passwordInputS.text()
                keepSignedIn = self.keepsignin.isChecked()
                if filehandler.OpenFile.checkForUserInDatabase("logininfo.json", username, password):
                        ...
                        MAKE_A_DAMN_ACCOUNT.setIcon(QMessageBox.WARNING)
                        MAKE_A_DAMN_ACCOUNT.setStandardButtons(QMessageBox.Ok | QMessageBox.Cancel)
